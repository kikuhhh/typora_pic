...
output_path = 'D:\\Desktop\\b站爬虫\\code\\lda\\result'
file_path = 'D:\\Desktop\\b站爬虫\\code\\lda\\data'
os.chdir(file_path)
data=pd.read_excel("data.xlsx")#content type
os.chdir(output_path)
dic_file = "D:\\Desktop\\b站爬虫\\code\\lda\\stop_dic\\dict.txt"
stop_file = "D:\\Desktop\\b站爬虫\\code\\lda\\stop_dic\\stopwords.txt"
...
plt.show()
plt.savefig(output_path+'困惑度.jpg')
