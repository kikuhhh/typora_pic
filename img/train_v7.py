...
import test_v7 as test  # import test.py to get mAP after each epoch
from models.experimental import attempt_load
from models.yolo import Model
from utils.autoanchor import check_anchors
from utils.datasets_v7 import create_dataloader
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str,
                        default='cfg/yolov7-tiny.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str,
                        default='data/detect_ssl.yaml', help='data.yaml path')
    parser.add_argument(
